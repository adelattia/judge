...
RUN apt-get -y update && apt-get install -y --no-install-recommends python python2.7-dev python3 python-dev libevent-dev python-pip build-essential gcc g++ wget file && apt-get clean
